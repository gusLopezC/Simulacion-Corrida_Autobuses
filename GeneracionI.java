...
public class GeneracionI {
	...
	public void corrida(String nombreArchivo, int dia, int tretardo, int asientos) {
		...
		try {
			...
			for (int z = 0; z <= dia - 1; z++) {// dia
				...
				for (int i = 0; i < hora.length; i++) {
					...
					int Tdinero = (AsiCom * 56) + (AsiMed * 28) + (AsiIna * 14);
		...
		for (int i = 0; i <= dia - 1; i++) {
			...
			wr.write("Dia" + condia+"\n");
			condia++;
			System.out.println("\tIxmiquilpan \t   " + arrayBolC[i] + "      " + arrayBolM[i] + "      " + arrayBolI[i]);
			wr.write("\tIxmiquilpan \t   " + arrayBolC[i] + "      " + arrayBolM[i] + "      " + arrayBolI[i]+"\n");
		}
		condia = 1;
		...
		for (int i = 0; i <= dia - 1; i++) {
			...
			System.out.println("\tIxmiquilpan       $" + arrayDinC[i] + "   $" + arrayDinM[i] + "   \t$" + arrayDinI[i]);
			wr.write("\tIxmiquilpan       $" + arrayDinC[i] + "   $" + arrayDinM[i] + "   \t$" + arrayDinI[i]+"\n");
		}
		condia = 1;
		...
		for (int i = 0; i <= dia - 1; i++) {
			System.out.println("Dia" + (condia) + "\tIxmiquilpan " + "	  \t" + arrayPro[i]+ "%");
			wr.write("Dia" + (condia) + "\tIxmiquilpan " + "	  \t" + arrayPro[i]+ "%\n");
			condia++;
